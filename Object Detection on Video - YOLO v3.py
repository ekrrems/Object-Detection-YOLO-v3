...
video = cv2.VideoCapture(r'C:\Users\ekrem\OneDrive\Masaüstü\resim\traffic-cars.mp4')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(r'C:\Users\ekrem\OneDrive\Masaüstü\resim/result-traffic-cars.mp4', fourcc, 30,
